...
#define AIC32X4_RATES	(SNDRV_PCM_RATE_8000_96000 | SNDRV_PCM_RATE_16000)
...
int aic32x4_probe(struct device *dev, struct regmap *regmap)
{
	...
	if (IS_ERR(aic32x4->mclk)) {
		dev_warn(dev, "Failed getting the mclk. The current implementation does not support the usage of this codec without mclk\n");
		aic32x4->mclk = NULL;
	}
